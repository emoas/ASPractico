...
// Filtro inventado
export const addHolaBruno = (input: CustomData): CustomData => {
    let result: string = "HOLA BRUNO " + input.data;        
    console.log(`Filtro addHolaBruno,  input${JSON.stringify(input)}, output ${result} }`)
    return {data: result}
};
